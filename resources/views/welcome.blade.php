...
<!-- Mirrored from whatsapp.com/ar/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 12:41:21 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8" />
<title>بوابة واتس اب API لإرسال الرسائل و الشات بوت - واتساااب مسج</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="بوابة واتس اب من أجل التشات بوت وارسال رسائل ، ميديا ، تسويق ، حملات PHP, nodejs , JavaScript, and Python" />
<meta name="keywords" content="WhatsApp API,whatsapp business api,whatsapp api service,whatsapp api integration,WhatsApp API PHP,WhatsApp API nodejs,WhatsApp API Python,WhatsApp gateway,WhatsApp API gateway,WhatsApp bot,chatbot" />
<meta name="website" content="https://whatsapp.com/" />
<link rel="canonical" href="index.html">
<link rel="shortcut icon" href="../home/assets/images/logo-icon.png" />
<link rel="icon" type="image/x-icon" href="https://whatsapp.com/home/assets/images/favicon.ico">
<link rel="icon" type="image/svg+xml" href="https://whatsapp.com/home/assets/images/favicon.svg">
<link rel="icon" type="image/png" href="../home/assets/images/favicon.png">
<meta name="yandex-verification" content="6893d8c13d37b4be" />

<meta property="og:type" content="website">
<meta property="og:url" content="index.html">
<meta property="og:title" content="بوابة واتس اب API لإرسال الرسائل و الشات بوت - واتساااب مسج">
<meta property="og:description" content="بوابة واتس اب من أجل التشات بوت وارسال رسائل ، ميديا ، تسويق ، حملات PHP, nodejs , JavaScript, and Python">
<meta property="og:image" content="../home/assets/images/whatsapp-card.png">
...
<meta name="twitter:title" content="بوابة واتس اب API لإرسال الرسائل و الشات بوت - واتساااب مسج">
<meta name="twitter:description" content="بوابة واتس اب من أجل التشات بوت وارسال رسائل ، ميديا ، تسويق ، حملات PHP, nodejs , JavaScript, and Python">
<meta name="twitter:image" content="{{ asset('home/assets/images/whatsapp-card.png') }}">
<link href="{{ asset('home/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('home/assets/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('home/assets/css/line.css')}}" rel="stylesheet" />
<link href="{{ asset('home/assets/css/tiny-slider.css')}}" rel="stylesheet" />
<link href="{{ asset('home/assets/css/style.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('home/assets/css/style.rtl.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('home/assets/css/colors/cyan.css')}}" rel="stylesheet" />
<link href="{{ asset('home/assets/css/tomorrow-night-bright.css')}}" rel="stylesheet" />
<link href="{{ asset('home/assets/css/wbstyle.css')}}" rel="stylesheet" />
<script src="{{ asset('home/assets/js/jquery.min.js')}}"></script>
<script src="{{ asset('home/assets/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{ asset('home/assets/js/tiny-slider.js')}}"></script>
...
<script src="{{ asset('home/assets/js/highlight.site.pack.js')}}"></script>
<script src="{{ asset('home/assets/js/qrcode.min.')}}"></script>
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
	...
	})(window,document,'script','dataLayer','GTM-P4NVQ8F');</script>
...
<script type="application/ld+json">
{
	...
	"logo": "https://whatsapp.com/home/assets/images/logo-square.png",
	"description": "WhatsApp API: for chatbot and sending messages, media, marketing campaigns for PHP, nodejs , JavaScript, and Python"
},
"sameAs" : ["https://twitter.com/whatsapp"]
}
</script>
<style>
    body{
...
<body>
<div id="whatsappapi"> </div>

<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P4NVQ8F"
			height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>

<header id="topnav" class="defaultscroll sticky">
<div class="container">
<a class="logo" href="index.html">
<img src="../home/assets/images/logo-dark.png" height="24" class="logo-light-mode" alt="واتساااب مسج بوابة واتس اب API">
<img src="../home/assets/images/logo-light.png" height="24" class="logo-dark-mode" alt="واتساااب مسج بوابة واتس اب API">
</a>
...
<img src="../assets/img/lang/ar.png" class="img-flag mr-2" alt="العربية">
<span>العربية</span>
</button> --}}
<ul class="dropdown-menu">
<a href="https://whatsapp.com/" hreflang="en" rel="alternate" class="dropdown-item"> <img src="../assets/img/lang/en.png" class="img-flag mr-2" alt="English"> English </a>
<a href="https://whatsapp.com/es/" hreflang="es" rel="alternate" class="dropdown-item"> <img src="../assets/img/lang/es.png" class="img-flag mr-2" alt="español"> español </a>
<a href="https://whatsapp.com/pt/" hreflang="pt" rel="alternate" class="dropdown-item"> <img src="../assets/img/lang/pt.png" class="img-flag mr-2" alt="Português"> Português </a>
<a href="https://whatsapp.com/tr/" hreflang="tr" rel="alternate" class="dropdown-item"> <img src="../assets/img/lang/tr.png" class="img-flag mr-2" alt="Türkçe"> Türkçe </a>
<a href="https://whatsapp.com/ru/" hreflang="ru" rel="alternate" class="dropdown-item"> <img src="../assets/img/lang/ru.png" class="img-flag mr-2" alt="русский"> русский </a>
</ul>
</div>
<div id="navigation">
...
<section class="bg-half-260 bg-light d-table w-100" style="background: url('image/123.jpg') center center;">
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-12 text-center">
<div class="title-heading">
<h1 class="heading  mt-2 mb-2 text-primary">واتس اب API</h1>
<p class="badge rounded-pill bg-soft-primary mb-3">للشركات المتوسطة والكبيرة</p>
...
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-1 col-md-1 col-3 text-center py4 text-primary">
<a href="https://docs.whatsapp.com/?docs_tab=http-1_1" class="text-primary" target="_blank">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="43" height="43" viewBox="0 0 45 45">
...
<a href="#" class="text-primary" target="_blank">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="43" height="43" viewBox="0 0 45 45">
<path fill="#05a887" d="M31.528,32.626 C31.528,32.625 31.652,32.514 31.690,32.415 C39.824,28.244 36.063,24.236 33.438,24.775 C32.796,24.908 32.508,25.022 32.508,25.022 C32.508,25.022 32.747,24.653 33.203,24.493 C38.396,22.692 42.389,29.808 31.528,32.626 ZM26.787,19.945 C29.225,23.334 23.916,26.039 23.916,26.039 C23.916,26.039 26.557,23.902 24.464,21.524 C17.377,13.463 32.217,9.806 32.217,9.806 C22.763,15.218 24.509,16.786 26.787,19.945 ZM22.515,12.351 C15.476,17.838 20.910,20.965 22.512,24.540 C18.403,20.882 15.390,17.661 17.411,14.663 C20.380,10.263 28.604,8.130 26.787,1.066 C26.787,1.066 31.291,5.514 22.515,12.351 ZM17.557,24.618 C17.557,24.618 9.678,26.465 14.767,27.136 C16.916,27.420 21.198,27.355 25.189,27.024 C28.451,26.754 31.723,26.177 31.723,26.177 C31.723,26.177 30.574,26.663 29.742,27.223 C21.740,29.301 6.285,28.332 10.735,26.209 C14.496,24.413 17.557,24.618 17.557,24.618 ZM17.939,35.427 C21.375,35.815 23.130,35.759 26.915,35.053 C26.915,35.053 27.912,35.668 29.302,36.202 C20.815,39.791 10.094,35.994 16.760,34.156 C16.760,34.156 15.104,35.106 17.939,35.427 ZM16.702,31.118 C20.372,31.492 23.270,31.523 28.286,30.570 C28.286,30.570 28.978,31.264 30.068,31.644 C19.809,34.605 8.381,31.876 15.722,29.472 C15.722,29.472 13.865,30.828 16.702,31.118 ZM13.409,37.502 C13.409,37.502 12.866,37.465 11.915,37.668 C11.003,37.862 8.103,38.783 9.649,39.448 C13.951,41.295 29.441,40.853 34.339,39.389 C36.915,38.618 35.689,37.621 35.689,37.621 C40.176,39.619 25.939,43.635 8.637,40.866 C2.292,39.850 11.689,36.307 13.409,37.502 ZM31.984,42.278 C37.890,41.182 38.435,39.799 38.435,39.799 C38.152,43.445 26.162,44.212 18.356,43.719 C13.226,43.394 12.228,42.578 12.228,42.578 C17.101,43.372 25.321,43.516 31.984,42.278 Z" class="cls-1"></path>
</svg>
<p>Java</p>
</a>
</div>
...
<h2 class="title mt-3 mb-4 h4">كيفية الإستخدام ؟</h2>
<p class="text-muted para-desc mb-0 mx-auto">
سعر ثابت بدون رسوم خفية ، رسائل غير محدودة ، بدون تكلفة لكل رسالة </p>
<p class="text-muted para-desc mb-0 mx-auto">
البدء بعملية الإرسال بأقل من 5 دقائق </p>
</div>
</div>
</div>
<div class="row">
...
<i class="uil uil-signin h2 text-primary"></i>
</div>
<div class="content mt-4">
<h3 class="h5">إنشاء حساب</h3>
<p class="text-muted mb-0">قم بالتسجيل وإنشاء الجهاز الخاص بك للحصول على instance id و token</p>
</div>
</div>
</div>
<div class="col-md-4 col-12 mt-5">
<div class="features text-center">
<div class="image position-relative d-inline-block">
<i class="uil uil-qrcode-scan h2 text-primary"></i>
</div>
<div class="content mt-4">
<h4 class="h5">امسح رمز QR</h4>
<p class="text-muted mb-0">امسح رمز qr لمصادقة الجهاز الخاص بك لإرسال رسائل عبر رقم الواتس اب الخاص بك</p>
</div>
</div>
</div>
<div class="col-md-4 col-12 mt-5">
<div class="features text-center">
<div class="image position-relative d-inline-block">
<i class="uil uil-message h2 text-primary"></i>
</div>
<div class="content mt-4">
<h5>ابدأ في إرسال الرسائل</h5>
<p class="text-muted mb-0">ابدأ في إرسال الرسائل عبر api بلغات البرمجة المفضلة لديك</p>
</div>
</div>
</div>
</div>
...
<h4 class="title mt-3 mb-4">ابدأ العمل مع whatsapp وأرسل الرسائل عبر خدمة واتس اب بزنس API</h4>
<p class="text-muted mb-0">قم بدمج الواتس اب مع أنظمتك ERP أو CRM أو تطبيقك أو موقع الويب الخاص بك ... إلخ.</p>
<p class="text-muted mb-0">يمكنك استخدام أي لغة قابلة للبرمجة بسهولة.</p>
</div>
</div>
</div>
</div>
...
<div class="col mt-4 pt-2" id="nav-tabs">
    <img src="{{ asset('image/11.PNG') }}" alt="" srcset="" style="
    width: 100%;
">
</div>
</div>
...
<div class="col-12 text-center">
<div class="section-title mb-4 pb-2">
<h4 class="title mb-4">الواجهات البرمجية واتساب مسج سهلة للمطورين للتكامل والربط مع اي لغة برمجية</h4>
<p class="text-muted para-desc mb-0 mx-auto">واتساااب مسج هي واجهة برمجة تطبيقات متعددة الوظائف للواتس اب ، وتعد من أفضل الأدوات للشركات والمبرمجين ، والتي يمكن دمجها في أي نظام محاسبة العملاء أو CRM أو ERP أو موقع ويب لإرسال الرسائل والإشعارات وغير ذلك الكثير. </p>
</div>
</div>
</div>
<div class="row align-items-center">
<div class="col-lg-5 col-md-6 mt-4 pt-2">
<img loading="lazy" src="home/assets/images/SEO_SVG.svg" alt="الواجهات البرمجية واتساب مسج سهلة للمطورين للتكامل والربط مع اي لغة برمجية">
</div>
<div class="col-lg-7 col-md-6 mt-4 pt-2">
<div class="section-title ms-lg-5">
<h4 class="title mb-4"> تواصل مع عملائك من خلال واتس اب API</h4>
<p class="text-muted">يمكنك الوصول إلى أكثر من 2.1 مليار مستخدم حول العالم باستخدام واتساب بزنس api</p>
<ul class="list-unstyled text-muted">
<li class="mb-1"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>زيادة معدل قراءة الرسائل 20X</li>
<li class="mb-1"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>تقليص وقت معالجة طلبات العملاء 80%</li>
<li class="mb-1"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>وقت انتظار أقل للعملاء </li>
</ul>
</div>
</div>
</div>
...
<div class="col-12 text-center">
<div class="section-title mb-4 pb-2">
<h4 class="title mb-4">استخدامات واتس اب API الأكثر شيوعاً</h4>
</div>
</div>
</div>
<div class="row">
...
<div class="flex-1">
<h4 class="title mb-0">تشات بوت</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">التسويق و إعادة الإستهداف</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">دعم العملاء</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">رسائل الوسائط المتعددة</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">الإشعارات</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">رسائل التذكير</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">رسائل رمز التحقق</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">التواصل مع العملاء</h4>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 mt-4 pt-2">
...
<div class="flex-1">
<h4 class="title mb-0">الأتمتة</h4>
</div>
</div>
</div>
</div>
...
<div id="ultra_tutorials"> </div>

<div id="ultra_price"> </div>
<section class="section">
<div class="container">
...
<div id="ultra_faq"> </div>
<section class="section">
<div class="container">
<center>
<h4 class="text-primary mb-5">الأسئلة الشائعة</h4>
</center>
<div class="row">
...
<div class="flex-1">
<h5 class="mt-0">ماهي واتساااب مسج ؟</h5>
<p class="answer text-muted mb-0">واتساااب مسج هو مزود واتس اب API وبوابة لإرسال واستقبال الرسائل للأعمال.</p>
<p class="answer text-muted mb-0">إذا كنت تتطلع إلى الاتصال بعملائك عبر واتس اب أو إنشاء وربط الواتس اب بنظام خاص بك (سواء كان نظام CRM / ERP أو تشات بوت أو نظام أساسي آخر) ،فإن واتساااب مسج سيكون خيارك الأمثل للإستفادة من واتس اب الأعمال.</p></p>
</div>
</div>
</div>
...
<i data-feather="help-circle" class="fea icon-ex-md text-primary me-2 mt-1"></i>
<div class="flex-1">
<h5 class="mt-0">ماذا تقدم واتساااب مسج ؟</h5>
<p class="answer text-muted mb-0">يقوم واتساااب مسج بأداء العديد من الوظائف.</p>
<p class="answer text-muted mb-0">كما ستتمكن من إرسال جميع أنواع الملفات والرسائل عبر الواتس اب ، وإنشاء وإدارة الأجهزة تلقائيًا ، وقراءة الرسائل الواردة من العملاء بواسطة الويب هوك .</p>
</div>
</div>
</div>
...
<i data-feather="help-circle" class="fea icon-ex-md text-primary me-2 mt-1"></i>
<div class="flex-1">
<h5 class="mt-0">ما مدى استقرار خدمة واتساااب مسج ؟</h5>
<p class="answer text-muted mb-0">
<p class="text-muted mb-0">لقد منحنا الأولوية للاستقرار والسلامة. كما نضمن: </p>
<p class="text-muted mb-0">- سيرفرات مستقرة 99.9٪</p>
<p class="text-muted mb-0">- الدعم الفني 24/7</p>
<p class="text-muted mb-0">- تحديث الخدمة بشكل مستمر .</p>
</p>
</div>
</div>
</div>
...
<i data-feather="help-circle" class="fea icon-ex-md text-primary me-2 mt-1"></i>
<div class="flex-1">
<h5 class="mt-0">هل يمكن ارسال رسائل جماعية ؟</h5>
<p class="answer text-muted mb-0">
<p class="text-muted mb-0">ليس لدى واتساااب مسج حد لعدد الرسائل التي يمكنك إرسالها.</p>
<p class="text-muted mb-0">نحن لا نوصي بإرسال أكثر من 5000 رسالة في اليوم.</p>
<p class="text-muted mb-0">عند إرسال رسائل جماعية ، قد يقوم المستخدمون بوضع علامة على رسائلك كرسائل غير مرغوب فيها مما سيؤدي إلى حظر رقمك.</p>
<p class="text-muted mb-0">لذا احرص على إرسال الرسائل إلى عملائك فقط. ويجب ألا تكون الرسائل سبام أو إعلانات مزعجة. يجب أن تكون الرسائل خدمات (تذكير - OTP - اشتراك - أو أي رسالة ينتظرها العميل ... إلخ</p>
</p>
</div>
</div>
</div>
...
<h4 class="title mb-4">هل لديك سؤال ؟ ابقى على تواصل!</h4>
<p class="text-muted para-desc mx-auto">
<p class="text-muted mb-0">نستمع دائما لأراء عملائنا</p>
<p class="text-muted mb-0">هذا هو السبب في تميز واتساااب مسج بواجهات وميزات احترافيه وبنفس الوقت سهلة الاستخدام.</p>
<p class="text-muted mb-0">إذا كانت لديك أي اقتراحات ، لاتتردد بالتواصل معنا .</p>
</p>
<a href="#" class="btn btn-primary mt-4"><i class="uil uil-phone me-2"></i>اتصل بنا</a>
</div>
</div>
</div>
</div>
...
<span>مرحبا ، كيف يمكنني مساعدتك ؟</span>
</span>
</a>
</div>
<footer class="footer">
...
<img src="../home/assets/images/logo-light.png" height="24" alt="واتساااب مسج بوابة واتس اب API">
</a>
<p class="mt-4">ابدأ العمل مع <span class="text-primary fw-bold">whatsapp</span> و ارسل رسائل غير محدودة عبر WhatsApp REST API ، وسنوفر كل ما تحتاجه حول الدعم الفني والبنية التحتية. </p>
<ul class="list-unstyled social-icon foot-social-icon mb-0 mt-4 d-none">
...
<div class="col-lg-2 col-md-2 col-12 mt-4 mt-sm-4 pt-2 pt-sm-0">
<h5 class="footer-head">واتساااب مسج</h5>
<ul class="list-unstyled footer-list mt-4">
<li><a href="/" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>الرئيسية</a></li>
<li><a href="#whatsapp-api" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>API </a></li>
<li><a href="#ultra_tutorials" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>الشروحات </a></li>
<li><a href="#ultra_price" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>الأسعار </a></li>
<li><a href="#ultra_faq" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>الأسئلة الشائعة </a></li>
<li><a href="https://whatsapp.com/cdn-cgi/l/email-protection#c9a0a7afa689bca5bdbba8a4baaee7aaa6a4" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>اتصل بنا</a></li>
<li><a href="/admin/login" target="_blank" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>تسجيل الدخول</a></li>
</ul>
</div>
<div class="col-lg-3 col-md-3 col-12 mt-4 mt-sm-4 pt-2 pt-sm-0">
<h5 class="footer-head">روابط مفيدة</h5>
<ul class="list-unstyled footer-list mt-4">
<li><a href="#" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>إنشاء رابط واتس اب API</a></li>
<li><a href="#" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>الشروط و الأحكام</a></li>
<li><a href="#" class="text-foot"><i class="uil uil-angle-left-b me-1"></i>سياسة الخصوصية</a></li>
<li><a href="#" class="text-foot" target="_blank"><i class="uil uil-angle-left-b me-1"></i>وثائق API</a></li>
</ul>
</div>
<div class="col-lg-3 col-md-3 col-12 mt-4 mt-sm-4 pt-2 pt-sm-0">
<h5 class="footer-head">Integrations</h5>
<ul class="list-unstyled footer-list mt-4">
<li><a href="https://www.pabbly.com/connect/integrations/whatsapp/" class="text-foot" target="_blank" rel="noreferrer noopener"><i class="uil uil-angle-left-b me-1"></i>Pabbly</a></li>
<li><a href="https://pipedream.com/apps/whatsapp/" class="text-foot" target="_blank" rel="noreferrer noopener"><i class="uil uil-angle-left-b me-1"></i>Pipedream</a></li>
<li><a href="https://integrately.com/integrations/whatsapp" class="text-foot" target="_blank" rel="noreferrer noopener"><i class="uil uil-angle-left-b me-1"></i>Integrately</a></li>
</ul>
</div>
</div>
</div>
...
<div class="container text-center direction_ltr">
<div class="row align-items-center">
<div class="col-sm-6">
<div class="text-sm-end">
<p class="mb-0">©
<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear())</script> wmc-ksa <i class="mdi mdi-heart text-danger"></i> by <a href="https://wmc-ksa.com/home/index.php" class="text-reset">whatsapp</a>.
</p>
</div>
</div>
<div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
<ul class="list-unstyled text-sm-start mb-0">
<li class="list-inline-item"><img src="../home/assets/images/payments/american-ex.png" class="avatar avatar-ex-sm" title="American Express" alt="payment"></li>
...
$(document).ready(function () {
	...
	if(qrcode){
		const qrcode = new QRCode(document.getElementById('qrcode'), {
			text: 'https://api.whatsapp.com/send?phone=966553907575&text=hi',
			width: 185,
			height: 185,
			colorDark : '#000',
			colorLight : '#fff',
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"84e2072f0b56599b","version":"2024.1.0","r":1,"token":"661d62f26d854a6893e0c60fd6b2697e","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from whatsapp.com/ar/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 12:41:31 GMT -->
</html>
