  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="{{ route('register') }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" name="name_company" placeholder="اسم المؤسسة">
            <div class="input-group-append">
              <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <input type="phone" class="form-control" name="phone" placeholder="رقم  الوتساب">
            <div class="input-group-append">
              <div class="input-group-text">
      ...
      <a href="{{url('login')}}" class="text-center">لديك حساب؟</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
